...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DEV"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DEV"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DEV"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DEV"));
