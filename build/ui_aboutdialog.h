...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About TestCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>TestCoin</b> version", 0));
...
"Copyright \302\251 2017-2018 The TestCoin developers", 0));
