...
// Copyright (c) 2017-2018 The TestCoin developers
...
static void getHardcodedSeeds(std::vector<CAddress> &vSeedsOut)
{
    ...
    {
        CAddress addr(CService(ips[i], 11710));
...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "A new stddar has been born, saving our environment. 10/03/2dddd018 - TestCoin";
	...
	// original 1516154401
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1520638720; // 10-03-2018
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 117106;
        ...
        assert(hashGenesisBlock == uint256("905bb7baea92ecf7dc3a3a43b604a7e95c00eed09b5ab89d9e5824396d321b57"));
        assert(genesis.hashMerkleRoot == uint256("2efdeeaf849ebb79c567f0c510f2106bb0250e9f6202e4ce94ef839ef7f8ac1d"));
